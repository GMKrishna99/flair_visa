...
const ContactUs = () => {
  ...
  const [isSuccess, setIsSuccess] = useState(false); // For success screen
    ...
    <section className="custom_container">
      ...
      <div className="py-8 px-6 md:px-2">
        ...
        <div className="flex flex-wrap items-center justify-center bg-white shadow-md rounded-xl p-6 md:p-12">
          <div className="w-full lg:w-1/2 lg:mb-0 pr-6 pb-8">
          ...
          {/* Right Side - Form */}
          <div className="w-full lg:w-1/2 bg-white shadow-md rounded-xl p-6 md:p-12 border border-gray-200">
