...
const MapComponent = () => {
  ...
  return (
    <div className="mt-12 relative">
      ...
      <div className=" absolute top-[19%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 bg-[#181621] rounded-lg shadow-lg p-6 w-80">
      ...
      <div className="absolute bg-white top-28 left-[46.5%] w-0 h-0 border-l-10 border-l-transparent border-r-10 border-r-transparent border-t-[20px] border-t-[#181621] rotate-6"></div>
    </div>
  );
};
